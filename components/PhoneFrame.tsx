...
export function PhoneFrame({ children }: PhoneFrameProps) {
  return (
    <>
      {/* Mobile View - Full screen on actual mobile devices */}
      <div className="block md:hidden w-full min-h-screen bg-background">
        {children}
      </div>

      {/* Desktop View - Phone mockup frame for desktop */}
      <div className="hidden md:flex items-center justify-center min-h-screen bg-blue-50 p-4">
        {/* Phone Container */}
